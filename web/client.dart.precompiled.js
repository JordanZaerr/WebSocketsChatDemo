...
["chat", "chat/chatprogram.dart", , K, {
  "^": "",
  ChatClient: {
    "^": "Object;_chat$_name,_socket,_controller",
    connect$1: function(address) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new K.ChatClient_connect_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    send$1: function(_, message) {
      var t1 = this._socket;
      if (t1 != null && t1.readyState === 1)
        t1.send(C.JsonCodec_null_null.encode$1(H.fillLiteralMap(["n", this._chat$_name, "m", message], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null))));
      else
        P.print("Socket not ready...");
    },
  ...
  ChatClient_connect_closure: {
    "^": "Closure:11;this_0",
    call$1: function(msg) {
      var t1, msgData, t2, t3;
      t1 = J.getInterceptor$x(msg);
      P.print(C.JSString_methods.$add("received msg: ", t1.get$data(msg)));
      msgData = C.JsonCodec_null_null.decode$1(t1.get$data(msg));
      t1 = this.this_0._controller;
      t2 = J.getInterceptor$asx(msgData);
      t3 = t2.$index(msgData, "n");
      t2 = t2.$index(msgData, "m");
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(new K.ChatEvent(t3, t2));
    }
  },
  ChatEvent: {
    "^": "Object;_chat$_name,_chat$_message",
    get$name: function(_) {
      return this._chat$_name;
    },
    get$message: function(_) {
      return this._chat$_message;
    }
  },
  ChatProgram: {
    "^": "Object_StreamExtensions;",
    Execute$0: function() {
      var t1, t2, t3;
      t1 = this.getName$0().then$1(new K.ChatProgram_Execute_closure()).then$1(this.get$setupClient()).then$1(new K.ChatProgram_Execute_closure0(this));
      t2 = $.Zone__current;
      t3 = P._registerErrorHandler(new K.ChatProgram_Execute_closure1(), t2);
      t2.toString;
      t1._addListener$1(H.setRuntimeTypeInfo(new P._Future(0, t2, null, null, null, null, t3, null), [null]));
    },
    getName$0: function() {
      var completer, nameElement;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      nameElement = document.querySelector("#name");
      this.addEnterKeyListener$2(nameElement, true).listen$1(new K.ChatProgram_getName_closure(completer, nameElement));
      this.addSubscription$2(J.get$onClick$x(document.querySelector("#setName")), new K.ChatProgram_getName_closure0(completer, nameElement));
      return completer.future;
    },
    setupClient$1: [function(client) {
      client.connect$1("ws://127.0.0.1:4040/ws");
      client.get$onMessage(client).listen$1(new K.ChatProgram_setupClient_closure());
      return client;
    }, "call$1", "get$setupClient", 2, 0, 14],
    attachSendMessageHandler$3: function(client, stream, msgBox) {
      H.setRuntimeTypeInfo(new P._WhereStream(new K.ChatProgram_attachSendMessageHandler_closure(msgBox), stream), [H.getRuntimeTypeArgument(stream, "Stream", 0)]).listen$1(new K.ChatProgram_attachSendMessageHandler_closure0(client, msgBox));
    }
  },
  Object_StreamExtensions: {
    "^": "Object+StreamExtensions;"
  },
  ChatProgram_Execute_closure: {
    "^": "Closure:11;",
    call$1: function($name) {
      var t1;
      document.querySelector("div:first-of-type").textContent = "Hello " + H.S($name);
      document.querySelector("div:nth-of-type(2)").hidden = false;
      t1 = new K.ChatClient(null, null, null);
      t1._chat$_name = $name;
      t1._controller = P.StreamController_StreamController$broadcast(null, null, false, null);
      return t1;
    }
  },
  ChatProgram_Execute_closure0: {
    "^": "Closure:11;this_0",
    call$1: function(client) {
      var msgBox, t1;
      msgBox = document.querySelector("#msg");
      t1 = this.this_0;
      t1.attachSendMessageHandler$3(client, t1.addEnterKeyListener$1(msgBox), msgBox);
      t1.attachSendMessageHandler$3(client, J.get$onClick$x(document.querySelector("#sendMsg")), msgBox);
      msgBox.focus();
    }
  },
  ChatProgram_Execute_closure1: {
    "^": "Closure:11;",
    call$1: function(e) {
      return P.print(J.toString$0(e));
    }
  },
  ChatProgram_getName_closure: {
    "^": "Closure:11;completer_0,nameElement_1",
    call$1: function(_) {
      var t1, t2;
      t1 = J.get$value$x(this.nameElement_1);
  ...
  ChatProgram_getName_closure0: {
    "^": "Closure:11;completer_2,nameElement_3",
    call$1: function(_) {
      var t1, t2;
      t1 = J.get$value$x(this.nameElement_3);
  ...
  ChatProgram_setupClient_closure: {
    "^": "Closure:15;",
    call$1: function(data) {
      ...
      t2.textContent = H.S(t3.get$name(data)) + " - " + H.S(t3.get$message(data));
      return t1.add$1(0, t2);
    }
  },
  ChatProgram_attachSendMessageHandler_closure: {
    "^": "Closure:11;msgBox_0",
    call$1: function(_) {
      return J.get$isNotEmpty$asx(J.get$value$x(this.msgBox_0));
    }
  },
  ChatProgram_attachSendMessageHandler_closure0: {
    "^": "Closure:11;client_1,msgBox_2",
    call$1: function(_) {
      var t1, t2;
      t1 = this.msgBox_2;
      t2 = J.getInterceptor$x(t1);
      J.send$1$x(this.client_1, t2.get$value(t1));
      t2.set$value(t1, "");
    }
  },
  StreamExtensions: {
    "^": "Object;",
    addEnterKeyListener$2: function(element, unsubscribeAfterInitial) {
      var controller = P.StreamController_StreamController$broadcast(null, null, false, null);
      this.addSubscription$2(J.get$onKeyPress$x(element), new K.StreamExtensions_addEnterKeyListener_closure(unsubscribeAfterInitial, controller));
      return H.setRuntimeTypeInfo(new P._BroadcastStream(controller), [H.getTypeArgumentByIndex(controller, 0)]);
    },
    addEnterKeyListener$1: function(element) {
      return this.addEnterKeyListener$2(element, false);
    },
    addSubscription$2: function(stream, handler) {
      var sub = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, stream._html$_target, stream._eventType, W._wrapZone(null), stream._useCapture), [H.getTypeArgumentByIndex(stream, 0)]);
      sub._tryResume$0();
      if (sub._html$_target == null)
        H.throwExpression(new P.StateError("Subscription has been canceled."));
      sub._unlisten$0();
      sub._html$_onData = W._wrapZone(new K.StreamExtensions_addSubscription_closure(handler, sub));
      sub._tryResume$0();
    }
  },
  StreamExtensions_addEnterKeyListener_closure: {
    "^": "Closure:11;unsubscribeAfterInitial_0,controller_1",
    call$1: function(e) {
      var t1;
      if (J.get$keyCode$x(e) === 13) {
        t1 = this.controller_1;
        e = document.createEvent("Event");
        e.initEvent("EnterPressed", true, true);
        if (t1._state >= 4)
          H.throwExpression(t1._addEventError$0());
        t1._sendData$1(e);
        return this.unsubscribeAfterInitial_0;
      }
      return false;
    }
  },
  StreamExtensions_addSubscription_closure: {
    "^": "Closure:11;handler_0,sub_1",
    call$1: function(e) {
      if (this.handler_0.call$1(e) === true)
        this.sub_1.cancel$0();
    }
  },
  StreamExtensions_addSubscription_closure0: {
    "^": "Closure:11;",
    call$1: function(err) {
      return P.print(err.toString$0(0));
    }
  },
  StreamExtensions_addSubscription_closure1: {
    "^": "Closure:9;",
    call$0: function() {
      return P.print("Stream has completed");
    }
  }
}],
["", "client.dart", , U, {
...
["dart.async", "dart:async", , P, {
  ...
  _ControllerStream: {
    ...
    _createSubscription$1: function(cancelOnError) {
      ...
      subscription._next = subscription;
      t3 = t1._previous;
      subscription._previous = t3;
      subscription._next = t1;
      t3.set$_next(subscription);
      t1._previous = subscription;
      subscription._eventState = t1._state & 1;
      if (t1._next === subscription)
...
["dart.dom.html", "dart:html", , W, {
  ...
  Element: {
    ...
    get$onKeyPress: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_keypress._eventType, false), [null]);
    },
    $isElement: true,
    "%": ";Element"
  },
...
K.ChatEvent.$isChatEvent = true;
K.ChatEvent.$isObject = true;
...
K.ChatClient.$isChatClient = true;
K.ChatClient.$isObject = true;
...
{func: "ChatClient__dynamic", ret: K.ChatClient, args: [null]},
{func: "dynamic__ChatEvent", args: [K.ChatEvent]},
...
function dart_precompiled($collectedClasses) {
  ...
  function ChatClient(_chat$_name, _socket, _controller) {
    this._chat$_name = _chat$_name;
    this._socket = _socket;
    this._controller = _controller;
  }
  ChatClient.builtin$cls = "ChatClient";
  if (!"name" in ChatClient)
    ChatClient.name = "ChatClient";
  $desc = $collectedClasses.ChatClient;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatClient.prototype = $desc;
  function ChatClient_connect_closure(this_0) {
    this.this_0 = this_0;
  }
  ChatClient_connect_closure.builtin$cls = "ChatClient_connect_closure";
  if (!"name" in ChatClient_connect_closure)
    ChatClient_connect_closure.name = "ChatClient_connect_closure";
  $desc = $collectedClasses.ChatClient_connect_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatClient_connect_closure.prototype = $desc;
  function ChatEvent(_chat$_name, _chat$_message) {
    this._chat$_name = _chat$_name;
    this._chat$_message = _chat$_message;
  }
  ChatEvent.builtin$cls = "ChatEvent";
  if (!"name" in ChatEvent)
    ChatEvent.name = "ChatEvent";
  $desc = $collectedClasses.ChatEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatEvent.prototype = $desc;
  function ChatProgram() {
  }
  ChatProgram.builtin$cls = "ChatProgram";
  if (!"name" in ChatProgram)
    ChatProgram.name = "ChatProgram";
  $desc = $collectedClasses.ChatProgram;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram.prototype = $desc;
  function Object_StreamExtensions() {
  }
  Object_StreamExtensions.builtin$cls = "Object_StreamExtensions";
  if (!"name" in Object_StreamExtensions)
    Object_StreamExtensions.name = "Object_StreamExtensions";
  $desc = $collectedClasses.Object_StreamExtensions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Object_StreamExtensions.prototype = $desc;
  function ChatProgram_Execute_closure() {
  }
  ChatProgram_Execute_closure.builtin$cls = "ChatProgram_Execute_closure";
  if (!"name" in ChatProgram_Execute_closure)
    ChatProgram_Execute_closure.name = "ChatProgram_Execute_closure";
  $desc = $collectedClasses.ChatProgram_Execute_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_Execute_closure.prototype = $desc;
  function ChatProgram_Execute_closure0(this_0) {
    this.this_0 = this_0;
  }
  ChatProgram_Execute_closure0.builtin$cls = "ChatProgram_Execute_closure0";
  if (!"name" in ChatProgram_Execute_closure0)
    ChatProgram_Execute_closure0.name = "ChatProgram_Execute_closure0";
  $desc = $collectedClasses.ChatProgram_Execute_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_Execute_closure0.prototype = $desc;
  function ChatProgram_Execute_closure1() {
  }
  ChatProgram_Execute_closure1.builtin$cls = "ChatProgram_Execute_closure1";
  if (!"name" in ChatProgram_Execute_closure1)
    ChatProgram_Execute_closure1.name = "ChatProgram_Execute_closure1";
  $desc = $collectedClasses.ChatProgram_Execute_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_Execute_closure1.prototype = $desc;
  function ChatProgram_getName_closure(completer_0, nameElement_1) {
    this.completer_0 = completer_0;
    this.nameElement_1 = nameElement_1;
  }
  ChatProgram_getName_closure.builtin$cls = "ChatProgram_getName_closure";
  if (!"name" in ChatProgram_getName_closure)
    ChatProgram_getName_closure.name = "ChatProgram_getName_closure";
  $desc = $collectedClasses.ChatProgram_getName_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_getName_closure.prototype = $desc;
  function ChatProgram_getName_closure0(completer_2, nameElement_3) {
    this.completer_2 = completer_2;
    this.nameElement_3 = nameElement_3;
  }
  ChatProgram_getName_closure0.builtin$cls = "ChatProgram_getName_closure0";
  if (!"name" in ChatProgram_getName_closure0)
    ChatProgram_getName_closure0.name = "ChatProgram_getName_closure0";
  $desc = $collectedClasses.ChatProgram_getName_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_getName_closure0.prototype = $desc;
  function ChatProgram_setupClient_closure() {
  }
  ChatProgram_setupClient_closure.builtin$cls = "ChatProgram_setupClient_closure";
  if (!"name" in ChatProgram_setupClient_closure)
    ChatProgram_setupClient_closure.name = "ChatProgram_setupClient_closure";
  $desc = $collectedClasses.ChatProgram_setupClient_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_setupClient_closure.prototype = $desc;
  function ChatProgram_attachSendMessageHandler_closure(msgBox_0) {
    this.msgBox_0 = msgBox_0;
  }
  ChatProgram_attachSendMessageHandler_closure.builtin$cls = "ChatProgram_attachSendMessageHandler_closure";
  if (!"name" in ChatProgram_attachSendMessageHandler_closure)
    ChatProgram_attachSendMessageHandler_closure.name = "ChatProgram_attachSendMessageHandler_closure";
  $desc = $collectedClasses.ChatProgram_attachSendMessageHandler_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_attachSendMessageHandler_closure.prototype = $desc;
  function ChatProgram_attachSendMessageHandler_closure0(client_1, msgBox_2) {
    this.client_1 = client_1;
    this.msgBox_2 = msgBox_2;
  }
  ChatProgram_attachSendMessageHandler_closure0.builtin$cls = "ChatProgram_attachSendMessageHandler_closure0";
  if (!"name" in ChatProgram_attachSendMessageHandler_closure0)
    ChatProgram_attachSendMessageHandler_closure0.name = "ChatProgram_attachSendMessageHandler_closure0";
  $desc = $collectedClasses.ChatProgram_attachSendMessageHandler_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ChatProgram_attachSendMessageHandler_closure0.prototype = $desc;
  function StreamExtensions() {
  }
  StreamExtensions.builtin$cls = "StreamExtensions";
  if (!"name" in StreamExtensions)
    StreamExtensions.name = "StreamExtensions";
  $desc = $collectedClasses.StreamExtensions;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StreamExtensions.prototype = $desc;
  function StreamExtensions_addEnterKeyListener_closure(unsubscribeAfterInitial_0, controller_1) {
    this.unsubscribeAfterInitial_0 = unsubscribeAfterInitial_0;
    this.controller_1 = controller_1;
  }
  StreamExtensions_addEnterKeyListener_closure.builtin$cls = "StreamExtensions_addEnterKeyListener_closure";
  if (!"name" in StreamExtensions_addEnterKeyListener_closure)
    StreamExtensions_addEnterKeyListener_closure.name = "StreamExtensions_addEnterKeyListener_closure";
  $desc = $collectedClasses.StreamExtensions_addEnterKeyListener_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StreamExtensions_addEnterKeyListener_closure.prototype = $desc;
  function StreamExtensions_addSubscription_closure(handler_0, sub_1) {
    this.handler_0 = handler_0;
    this.sub_1 = sub_1;
  }
  StreamExtensions_addSubscription_closure.builtin$cls = "StreamExtensions_addSubscription_closure";
  if (!"name" in StreamExtensions_addSubscription_closure)
    StreamExtensions_addSubscription_closure.name = "StreamExtensions_addSubscription_closure";
  $desc = $collectedClasses.StreamExtensions_addSubscription_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StreamExtensions_addSubscription_closure.prototype = $desc;
  function StreamExtensions_addSubscription_closure0() {
  }
  StreamExtensions_addSubscription_closure0.builtin$cls = "StreamExtensions_addSubscription_closure0";
  if (!"name" in StreamExtensions_addSubscription_closure0)
    StreamExtensions_addSubscription_closure0.name = "StreamExtensions_addSubscription_closure0";
  $desc = $collectedClasses.StreamExtensions_addSubscription_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StreamExtensions_addSubscription_closure0.prototype = $desc;
  function StreamExtensions_addSubscription_closure1() {
  }
  StreamExtensions_addSubscription_closure1.builtin$cls = "StreamExtensions_addSubscription_closure1";
  if (!"name" in StreamExtensions_addSubscription_closure1)
    StreamExtensions_addSubscription_closure1.name = "StreamExtensions_addSubscription_closure1";
  $desc = $collectedClasses.StreamExtensions_addSubscription_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StreamExtensions_addSubscription_closure1.prototype = $desc;
